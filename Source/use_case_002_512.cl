...
__kernel
void fdtdKernel(__global int* idGrid, __global float* modelGrid, __global float* boundaryGrid, int idxRotate, int idxSample, __global float* input, __global float* output, int inputPosition, __global int* outputPosition, float lambdaFive, float lambdaTwo, float lambdaFour, float lambdaSix, float lambdaThree, float lambdaOne, float strLambdaOne, float strLambdaFive, float strLambdaTwo, float strLambdaThree, float strLambdaFour, float damp)
{
